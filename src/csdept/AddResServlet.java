...
public class AddResServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String resType=request.getParameter("artype");
		String resName=request.getParameter("arname");
		String resDesc=request.getParameter("ardesc");
		
		ReserveDAO dao=new ReserveDAO();
		dao.AddResource(resType, resName,resDesc);
